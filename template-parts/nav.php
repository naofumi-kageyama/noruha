<ul class="p-template-nav">
    <li class="p-template-nav__item"><a class="p-template-nav__link" href="<?php echo esc_url(CFS()->get('link', 140)); ?>">Next</a></li>
    <li class="p-template-nav__item"><a class="p-template-nav__link" href="<?php echo esc_html(home_url('#declaration')); ?>">About</a></li>
    <li class="p-template-nav__item"><a class="p-template-nav__link" href="<?php echo esc_url(get_the_permalink(416)); ?>">Works</a></li>
