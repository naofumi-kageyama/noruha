<div class="p-works-main-visual">
    <figure class="p-works-main-visual__main-visual<?php if($args['cfs']->get('horizontal')) echo " p-works-main-visual__main-visual--horizontal"; ?>">
    ...
    <div class="p-works-main-visual__title-container">
        ...
        <p class="p-works-main-visual__subtitle"><?php echo $args['cfs']->get('subtitle'); ?></p>
    </div>
    <div class="p-works-main-visual__info-wrapper">
        <div class="p-works-main-visual__info-container">
            ...
            <p class="p-works-main-visual__info-text next-detail-text"><?php echo esc_html($args['cfs']->get('date')); ?></p>
        </div>
        <div class="p-works-main-visual__info-container">
        <h3 class="p-works-main-visual__info-heading c-heading-black-background">会場</h3>
            <p class="p-works-main-visual__info-text"><?php echo esc_html($args['cfs']->get('venue')); ?></p>
        </div>
    </div>
</div>