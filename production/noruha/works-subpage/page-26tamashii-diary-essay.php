    ...
    <div class="c-article">
        ...
        <article id="tomoda" class="mb-24 last:mb-0">
            ...
            <div class="mt-8 block md:flex md:justify-between md:items-center c-white-area">
                <div class="w-full md:w-1/4">
                    <figure class="">
                        <img src="<?php echo esc_html(get_template_directory_uri()); ?>/dist/images/image_tomoda.webp" alt="友田とんのプロフィール画像" width="1782" height="2048">
                    </figure>
                </div>
        ...
        <article id="shibuki" class="mb-24 last:mb-0">
            ...
            <div class="mt-8 block md:flex md:justify-between md:items-center c-white-area">
                <div class="w-full md:w-1/4">
                    <figure class="">
                        <img src="<?php echo esc_html(get_template_directory_uri()); ?>/dist/images/image_shibuki.webp" alt="渋木すずのプロフィール画像" width="768" height="1024">
                    </figure>
                </div>
                <div class="w-full md:w-[70%]">
        ...
        <article id="kiyohara" class="mb-24 last:mb-0">
            ...
            <div class="mt-8 block md:flex md:justify-between md:items-center c-white-area">
                <div class="w-full md:w-1/4">
                    <figure class="">
                        <img src="<?php echo esc_html(get_template_directory_uri()); ?>/dist/images/image_kiyohara.webp" alt="清原惟のプロフィール画像" width="1974" height="1314">
                    </figure>
                </div>
                <div class="w-full md:w-[70%]">
