<section class="c-works__section">
  <div class="p-template-works-description">
    <p class="p-template-works-description__copy">自己が不気味な他者として立ち現れてくる、奇妙な「現実」を描く現代の寓話</p>
    <div class="p-template-works-description__text c-rich-text next-description">
      ...
      <h3><strong>【掲示板】上演『幸福な島の夜』に関する調査</strong></h3>
      <p><a href="https://noruha.net/kofuku-bbs">https://noruha.net/kofuku-bbs</a></p>
    </div>
  </div>
</section>
<section class="c-works__section">
    ...
    <div class="p-template-works-info-member__list-container">
      <dl class="p-template-works-info-member__list js-open-profile-parent-wrapper">
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">作</span></dt>
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">串尾一輝（青年団 / グループ・野原）</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">西山真来（青年団）</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">藤瀬のりこ（青年団）</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">鐘築隼</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">本間菫子</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">舞台美術協力</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">植田晴帆</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">音響デザイン</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">カゲヤマ気象台*</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">衣装デザイン</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">飯島健太朗</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
    ...
    <div class="p-template-works-info-member__organizer-list-container">
      ...
      <div class="p-template-works-info-member__logo-pc c-rich-text js-set-attr-size">
        <p>
          ...
          />　<img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_act.png"
            alt=""
            width="82"
            height="42"
          />
    ...
    <ul class="p-23kofuku-symposium__symposium-list js-open-profile-parent-wrapper">
      <li class="p-23kofuku-symposium__symposium-item js-open-profile-parent">
        ...
        <ul class="p-23kofuku-symposium__guest-list js-open-profile-children-wrapper">
          <li class="p-23kofuku-symposium__guest-item">
            <h4 class="p-23kofuku-symposium__guest-heading">登壇者</h4>
          </li>
