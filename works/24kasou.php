...
<section class="p-works__section">
            ...
            <div class="p-works-info-member__container js-open-profile-container js-open-profile-child">
              ...
              <div class="p-works-info-member__profile-container c-white-area js-open-profile-target">
                ...
                <div class="p-works-info-member__profile c-content">
                  ...
                  <p>劇団青年団、舞台美術研究工房六尺堂所属。</p>
                  <p>桜美林大学芸術文化学群非常勤講師、桐朋学園芸術短期大学非常勤講師、日本大学芸術学部非常勤講師。</p>
                </div>
              </div>
            </div>
          </dd>
            ...
            <div class="p-works-info-member__container js-open-profile-container js-open-profile-child">
              ...
              <div class="p-works-info-member__profile-container c-white-area js-open-profile-target">
                ...
                <div class="p-works-info-member__profile c-content">
                  ...
                  <p>近年の主なデザイン作品に Apichatpong Weerasethakul “A Conversation with the Sun(VR)”<br />2024.2 @Chiang Rai/Thailand Biennale、鈴木ユキオ「刻の花」2023.12 @北九州芸術劇場、サエボーグ”Super Farm” 2023.7 @Frankfurt/Theater Der Welt など</p>
                </div>
              </div>
            </div>
          </dd>
    ...
    <div class="p-works-info-member__organizer-list-container">
      ...
      <div class="p-works-info-member__logo-pc c-content js-set-attr-size">
        <p>
          <img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_tokyo-festival.png"
            alt=""
            width="50"
            height="51"
          />　<img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_tokyo-metropolitan-theatre.png"
            alt=""
            width="130"
            height="30"
          />　<img
          ...
          />　<img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_tokyo.png"
            alt=""
            width="118"
            height="30"
          />
        ...
        <p>
          <img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_nihonhaku.png"
            alt=""
            width="88"
            height="30"
          />　<img
            loading="lazy"
            src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_asahi.png"
            alt=""
            width="132"
            height="30"
          />　<img
  ...
  <div class="p-works__info-section p-works-info-timetable">
    ...
    <div class="p-works-info-timetable__content c-content">
      <p>9月19日（木）19:00<br />
        ...
        9月22日（日・祝）14:00◯</p>
      <p>◎：見えない・見えづらいお客様のための「音声ガイド」を実施（要予約・日本語のみ）<br />
        〇：聞こえない・聞こえづらいお客様のための「ポータブル字幕機提供」を実施（要予約・日本語のみ）</p>
      <p>上演時間：約90分（途中休憩あり）<br />
  ...
  <div id="ticket" class="p-works__info-section p-works-info-ticket">
    ...
    <div class="p-works-info-ticket__content c-content js-set-attr-size">
      ...
      <p><img loading="lazy" src="<?php echo esc_html(get_template_directory_uri()); ?>/assets/images/logo_hearing-loop.png" alt="" width="100" height="81" /></p>
