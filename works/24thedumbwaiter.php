<section class="c-works__section">
  <div class="p-template-works-description">
    <p class="p-template-works-description__copy">地下室に指示を待つ殺し屋が二人。傍には料理昇降機（ダム・ウェイター）。 不条理演劇の金字塔に《円盤に乗る派》が挑む！</p>
    ...
    <div class="p-template-works-info-member__list-container">
      <dl class="p-template-works-info-member__list js-open-profile-parent-wrapper">
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">座長</span></dt>
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">座組</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">渋木すず（出演）</p>
            </div>
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">畠山峻（出演）</p>
            </div>
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">カゲヤマ気象台（ウォッチャー）</p>
            </div>
          </dd>
        </div>
      </dl>
      <p class="p-template-works-info-member__remarks js-open-profile-next-element">
        以上、円盤に乗る派<br>
        <br>
    ...
    <div class="p-template-works-info-member__organizer-list-container">
      <dl class="p-template-works-info-member__organizer-list">
        <div class="p-template-works-info-member__organizer-terms-container">
          <dt class="p-template-works-info-member__organizer-terms">企画制作・主催</dt>
