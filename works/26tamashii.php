<div class="c-works__additional-content c-white-area">
  ...
  <ul class="p-26tamashii__toc">
    ...
    <li class="p-26tamashii__toc-item"><a href="<?php echo esc_url(home_url('/tamashii/diary/')); ?>">『「いまのところまだ存在しているわたしのたましいが……」』を観た日の日記</a>を公開しました。(2026.5.1)</li>
    <li class="p-26tamashii__toc-item">カゲヤマ気象台によるエッセイ<a href="<?php echo esc_url(home_url('/tamashii/essay/')); ?>">『演劇と私的』</a>に記事を追加しました。(2026.3.11)</li>
    <li class="p-26tamashii__toc-item"><a href="<?php echo esc_url(home_url('/tamashii/submit-diary/')); ?>">『「いまのところまだ存在しているわたしのたましいが……」』を観た日の日記をお寄せください</a>(2026.3.10)</li>
    <li class="p-26tamashii__toc-item">カゲヤマ気象台によるエッセイ<a href="<?php echo esc_url(home_url('/tamashii/essay/')); ?>">『演劇と私的』</a>を公開しました。(2026.3.8)</li>
    <li class="p-26tamashii__toc-item"><a href="<?php echo esc_url(home_url('/tamashii/news-2026-02-24/')); ?>">出演者変更のお知らせ</a>(2026.2.24)</li>
    <li class="p-26tamashii__toc-item">ポッドキャスト<a href="<?php echo esc_url(home_url('/tamashii/hiyorigeta-no-rekishi-ni-kizame/')); ?>" target="_blank">『日和下駄の歴史に刻め！』</a>がスタートしました。(2026.2.23)</li>
...
<section class="c-works__section">
  <div class="p-template-works-description">
    <p class="p-template-works-description__copy">絶望、分断、戦争の時代を前に、われわれの「たましい」と「<ruby>業<rt>ごう</rt></ruby>」をめぐる物語が再生される……虚ろに</p>
    ...
    <div class="p-template-works-info-member__list-container">
      <dl class="p-template-works-info-member__list js-open-profile-parent-wrapper">
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">戯曲・演出</span></dt>
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">深澤しほ</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">横田僚平</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">渡邊まな実</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">音楽</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">灰街令</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">映像・アートワーク</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">ミヤオウ</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">舞台美術</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">佐々木文美</p>
            </div>
          </dd>
        </div>
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">吉田一弥（DEZAR inc.）</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">演出助手</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">山本ジャスティン伊等（Dr. Holiday Laboratory）</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">加藤七穂</p>
            </div>
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">広報</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
