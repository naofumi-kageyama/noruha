<section class="c-works__section">
  <div class="p-template-works-description">
    <p class="p-template-works-description__copy">幽霊、自我の喪失、顔の見えない誰かの欲望……すべてが仮想的な時代における、物語の”失調”</p>
  ...
  <div class="c-works__info-section p-template-works-info-member">
      ...
      <dl class="p-template-works-info-member__list js-open-profile-parent-wrapper">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">鶴田理紗</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">岩澤哲野</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">櫻内憧海(お布団／青年団) </p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">三毛あんり「面前の天使1」</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">大田拓未</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">広報動画</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">高良真剣</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
        ...
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          ...
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">飯塚なな子</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
            ...
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">円盤に乗る派</p>
            </div>
          </dd>
        </div>
        <div class="p-template-works-info-member__terms-container js-open-profile-parent">
          <dt class="p-template-works-info-member__terms"><span class="c-button">当日運営</span></dt>
          <dd class="p-template-works-info-member__description js-open-profile-children-wrapper">
            <div class="p-template-works-info-member__container js-open-profile-container js-open-profile-child">
              <p class="p-template-works-info-member__name js-open-profile-button">及川晴日</p>
              <div class="p-template-works-info-member__profile-container c-white-area js-open-profile-target">
                <button class="c-white-area__close-button js-open-profile-button"><span class="u-visually-hidden">close</span></button>
                <div class="p-template-works-info-member__profile c-rich-text">
    ...
    <div class="p-template-works-info-member__organizer-list-container">
      <dl class="p-template-works-info-member__organizer-list">
        ...
        <div class="p-template-works-info-member__organizer-terms-container">
          <dt class="p-template-works-info-member__organizer-terms">提携</dt>
          <dd class="p-template-works-info-member__organizer-description">
            公益財団法人武蔵野文化生涯学習事業団 </dd>
        </div>
        <div class="p-template-works-info-member__organizer-terms-container">
          <dt class="p-template-works-info-member__organizer-terms">協力</dt>
          <dd class="p-template-works-info-member__organizer-description">
