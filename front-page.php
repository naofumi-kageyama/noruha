                ...
                <div class="p-top-main-section__section-content p-top-main-section__members-content">
                    <div class="p-top-main-section__members-image">
                        <img width="2000" height="1334"
                            src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_members.jpg"
                            alt="円盤に乗る派のメンバー写真"  />
                    </div>
                    <div class="p-top-main-section__members-column-wrapper js-member-open-column-wrapper">
                        <div class="p-top-main-section__members-column js-member-open-column">
                            <div class="p-top-main-section__member-container js-member-open-container">
                                <div class="p-top-main-section__member-image-container js-member-open-button">
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_kageyama_off.jpg"
                                        class="p-top-main-section__member-image--off" alt="カゲヤマ気象台の写真" />
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_kageyama_on.jpg"
                            ...
                            <div class="p-top-main-section__member-container js-member-open-container">
                                <div class="p-top-main-section__member-image-container js-member-open-button">
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_geta_off.jpg"
                                        class="p-top-main-section__member-image--off" alt="日和下駄の写真" />
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_geta_on.jpg"
                        ...
                        <div class="p-top-main-section__members-column js-member-open-column">
                            <div class="p-top-main-section__member-container js-member-open-container">
                                <div class="p-top-main-section__member-image-container js-member-open-button">
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_hatakeyama_off.jpg"
                                        class="p-top-main-section__member-image--off" alt="畠山峻の写真" />
                                    <img width="720" height="480"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_hatakeyama_on.jpg"
                            ...
                            <div class="p-top-main-section__member-container js-member-open-container">
                                <div class="p-top-main-section__member-image-container js-member-open-button">
                                    <img width="1000" height="667"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_shibuki_off.jpg"
                                        class="p-top-main-section__member-image--off" alt="渋木すずの写真" />
                                    <img width="1000" height="667"
                                        src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/image_shibuki_on.jpg"
