<?php
/*
Template Name: 26tamashii-club
*/
?>
<?php get_header(); ?>
<main class="l-main c-works p-26tamashii-club-page c-content">
    <h1>乗る派クラブ#2「♨︎」1日限定オープン!</h1>
    ...
    <div class="p-26tamashii-club-page__description">
    ...
    <section class="p-26tamashii-club-page__info c-white-area">
        <h2>乗る派クラブ#2「♨︎」</h2>
        <p class="p-26tamashii-club-page__info-subtitle">サブタイトル：「『いまのところまだ存在しているわたしのたましい』が繰り返しこだまする空間が……（吉祥寺シアター）」</p>
        <p>
            ●日時<br>
        ...
        <p>
            ●お申込み<br>
            <a href="https://noruha-club-2.peatix.com" target="_blank" ref="noreferrer noopener">https://noruha-club-2.peatix.com</a><br>
            ※《乗る派クラブ》ロゴ入りオリジナルグッズをプレゼント（先着予約順・数量限定）
        </p>
        <p>企画：中條玲、中村みなみ</p>
        <div class="p-26tamashii-club-page__about">
            <div class="p-26tamashii-club-page__about-left">
                <h3>《乗る派クラブ》とは？</h3>
                <p class="p-26tamashii-club-page__about-text">《円盤に乗る派》から派生して立ち上げられた企画チーム。創作チームとは異なる視点で多様な企画を行うことで、演劇公演を単なる作品発表の場から、ここに集う様々な人たちのための《場所》へと展開させることを目指す。</p>
            </div>
            <div class="p-26tamashii-club-page__about-right">
                <div class="p-26tamashii-club-page__logo"><img src="<?php echo esc_attr(get_template_directory_uri() . '/assets/images/logo_club.png'); ?>" alt="乗る派クラブ" width="400" height="196"></div>
            </div>
        </div>
    </section>
    <section class="p-26tamashii-club-page__comment">
        <h2>「♨︎」に寄せて（文：増田義基）</h2>
        <p>吉祥寺シアターの空間を一つの楽器として鳴らします。</p>
        <p>シアターの中にマイクとスピーカーを点在させてハウリング（マイクとスピーカーの間で音波が無限ループして、合わせ鏡のように音が増幅され続ける現象）のスポットを出現させ、そのハウリングを波のようにいくつも重ねることで「吉祥寺シアタードローン」を作ります。フィードバックを繰り返す音は、空間の中の物体の配置、訪れるひとの動き、もの音、温度、湿度など、様々な要素によって絶えず変化し、その空間の状態を可聴化します。</p>
        <p>吉祥寺シアターではこの期間に仕込み、リハーサル、そして合計5回の公演を経て『「いまのところまだ存在しているわたしのたましいが……」』の戯曲の中の言葉や俳優の動き、音楽、照明のファンの音など、様々な音が発されては消えていくことを想像します。</p>
        ...
        <figure class="p-26tamashii-club-page__comment-image">
            <img src="<?php echo esc_attr(get_template_directory_uri()); ?>/assets/images/image_speaker.jpg" width="1200" height="900">
            <figcaption>画像は、コンピューターに欠かせないCPUの製造に使われるシリコンウェハに振動スピーカーとコンタクトマイクをつけ、自律的にハウリングを発生させる装置です。♨︎では3体が吉祥寺シアターに登場します。</figcaption>
        </figure>
        <div class="p-26tamashii-club-page__profile">
            ...
            <div class="p-26tamashii-club-page__profile-image">
    ...
    <section class="p-26tamashii-club-page__card p-26tamashii-card">
